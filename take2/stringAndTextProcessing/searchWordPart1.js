...
Notes:
- input is a word and a stringToSearch
- output is a number => count of times word appears in the stringToSearch

Algorithm:
- split the str to the array of words
- filter the words that match case insensitive
- return the length of the filter
*/

let searchWord = (search, text) => {
  return text
    .toLowerCase()
    .split(' ')
    .filter(word => {
